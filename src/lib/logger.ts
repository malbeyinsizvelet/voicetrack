...
export function createLogger(context: string) {
  return {
    debug: (message: string, data?: unknown) => output(createEntry('debug', message, context, data)),
    info:  (message: string, data?: unknown) => output(createEntry('info',  message, context, data)),
    warn:  (message: string, data?: unknown) => output(createEntry('warn',  message, context, data)),
    error: (message: string, data?: unknown) => output(createEntry('error', message, context, data)),
  };
}
